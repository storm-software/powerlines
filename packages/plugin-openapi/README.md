...
# Powerlines - OpenAPI Plugin

A Powerlines plugin to generate project code with [OpenAPI](https://openapis.org/).
...
- [Powerlines - OpenAPI Plugin](#powerlines---openapi-plugin)
...
```bash
pnpm add @powerlines/plugin-openapi
```
...
```bash
npm install @powerlines/plugin-openapi
```
...
```bash
yarn add @powerlines/plugin-openapi
```
...
Run `nx test plugin-openapi` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-openapi` to run
