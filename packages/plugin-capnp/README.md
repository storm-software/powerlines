...
# Powerlines - Cap'n Proto Plugin

A Powerlines plugin to generate project code with [Cap'n Proto](https://capnproto.org/).
...
```bash
pnpm add @powerlines/plugin-capnp
```
...
```bash
npm install @powerlines/plugin-capnp
```
...
```bash
yarn add @powerlines/plugin-capnp
```
...
Run `nx build plugin-capnp` to build the library.

### Running unit tests

Run `nx test plugin-capnp` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-capnp` to run
