...
# Powerlines - Unique Identifier Plugin
...
- [Powerlines - Unique Identifier Plugin](#powerlines---unique-identifier-plugin)
...
```bash
npm install @powerlines/plugin-id
```
...
Run `nx build plugin-id` to build the library.

### Running unit tests

Run `nx test plugin-id` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-id` to run
