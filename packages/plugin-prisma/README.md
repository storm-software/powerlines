...
# Powerlines - Prisma Plugin

A Powerlines plugin to generate project code with [Prisma](https://www.prisma.io/).
...
- [Powerlines - Prisma Plugin](#powerlines---prisma-plugin)
...
```bash
pnpm add @powerlines/plugin-prisma
```
...
```bash
npm install @powerlines/plugin-prisma
```
...
```bash
yarn add @powerlines/plugin-prisma
```
...
Run `nx build plugin-prisma` to build the library.

### Running unit tests

Run `nx test plugin-prisma` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-prisma` to run
