...
# Powerlines - TSDoc Configuration

A shared TSDoc configuration containing globals used in Powerlines projects.

<!-- START doctoc -->
<!-- DON'T EDIT THIS SECTION, INSTEAD RE-RUN doctoc TO UPDATE -->
## Table of Contents

- [Powerlines - TSDoc Configuration](#powerlines---tsdoc-configuration)
