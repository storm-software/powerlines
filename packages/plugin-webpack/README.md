...
# Powerlines - Webpack Plugin

A package containing a Powerlines plugin to build projects using [Webpack](https://webpack.js.org/).
...
- [Powerlines - Webpack Plugin](#powerlines---webpack-plugin)
...
```bash
pnpm add @powerlines/plugin-webpack
```
...
```bash
npm install @powerlines/plugin-webpack
```
...
```bash
yarn add @powerlines/plugin-webpack
```
...
Run `nx build plugin-webpack` to build the library.

### Running unit tests

Run `nx test plugin-webpack` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-webpack` to run
