...
# Powerlines - Rspack Plugin

A package containing a Powerlines plugin to build projects using [Rspack](https://rspack.rs).

<!-- START doctoc -->
<!-- DON'T EDIT THIS SECTION, INSTEAD RE-RUN doctoc TO UPDATE -->
## Table of Contents

- [Powerlines - Rspack Plugin](#powerlines---rspack-plugin)
...
```bash
pnpm add @powerlines/plugin-rspack
```
...
```bash
npm install @powerlines/plugin-rspack
```
...
```bash
yarn add @powerlines/plugin-rspack
```
...
Run `nx build plugin-rspack` to build the library.

### Running unit tests

Run `nx test plugin-rspack` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-rspack` to run
