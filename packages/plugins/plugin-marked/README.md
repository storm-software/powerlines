...
# Powerlines - Marked Plugin

A Powerlines plugin to generate project code with [Marked](https://marked.js.org).
...
```bash
pnpm add @powerlines/plugin-marked
```
...
```bash
npm install @powerlines/plugin-marked
```
...
```bash
yarn add @powerlines/plugin-marked
```
...
Run `nx build plugin-marked` to build the library.

### Running unit tests

Run `nx test plugin-marked` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-marked` to run
