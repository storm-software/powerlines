...
```bash
pnpm add @powerlines/plugin-unbuild
```
...
```bash
npm install @powerlines/plugin-unbuild
```
...
```bash
yarn add @powerlines/plugin-unbuild
```
...
Run `nx build plugin-unbuild` to build the library.

### Running unit tests

Run `nx test plugin-unbuild` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-unbuild` to run
