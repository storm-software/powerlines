...
# Powerlines - Open Telemetry Plugin

A package containing a Powerlines plugin for integrating Open Telemetry into Powerlines.
...
- [Powerlines - Open Telemetry Plugin](#powerlines---open-telemetry-plugin)
...
```bash
pnpm add @powerlines/plugin-open-telemetry
```
...
```bash
npm install @powerlines/plugin-open-telemetry
```
...
```bash
yarn add @powerlines/plugin-open-telemetry
```
...
Run `nx build plugin-open-telemetry` to build the library.

### Running unit tests

Run `nx test plugin-open-telemetry` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-open-telemetry` to run [ESLint](https://eslint.org/) on the package.
