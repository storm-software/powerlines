...
# Powerlines - Unified Plugin

A Powerlines plugin to generate project code with the [Unified](https://unified.js.org) ecosystem.
...
- [Powerlines - Unified Plugin](#powerlines---unified-plugin)
...
```bash
pnpm add @powerlines/plugin-unified
```
...
```bash
npm install @powerlines/plugin-unified
```
...
```bash
yarn add @powerlines/plugin-unified
```
...
Run `nx build plugin-unified` to build the library.

### Running unit tests

Run `nx test plugin-unified` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-unified` to run
