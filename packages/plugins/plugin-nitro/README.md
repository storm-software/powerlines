...
```bash
pnpm add @powerlines/plugin-nitro
```
...
```bash
npm install @powerlines/plugin-nitro
```
...
```bash
yarn add @powerlines/plugin-nitro
```
...
Run `nx build plugin-nitro` to build the library.

### Running unit tests

Run `nx test plugin-nitro` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-nitro` to run
