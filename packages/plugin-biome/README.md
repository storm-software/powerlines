...
- [Powerlines - Biome Plugin](#powerlines---biome-plugin)
...
```bash
pnpm add @powerlines/plugin-biome
```
...
```bash
npm install @powerlines/plugin-biome
```
...
```bash
yarn add @powerlines/plugin-biome
```
...
Run `nx lint plugin-biome` to run
