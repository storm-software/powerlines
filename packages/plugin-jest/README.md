...
# Powerlines - Jest Plugin

A package containing the Jest testing plugin for Powerlines, various helper utilities, and shared configurations.
...
```bash
pnpm add @powerlines/plugin-jest
```
...
```bash
npm install @powerlines/plugin-jest
```
...
```bash
yarn add @powerlines/plugin-jest
```
...
Run `nx build plugin-jest` to build the library.

### Running unit tests

Run `nx test plugin-jest` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-jest` to run
