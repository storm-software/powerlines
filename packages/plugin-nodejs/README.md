...
```bash
pnpm add @powerlines/plugin-nodejs
```
...
```bash
npm install @powerlines/plugin-nodejs
```
...
```bash
yarn add @powerlines/plugin-nodejs
```
...
Run `nx build plugin-nodejs` to build the library.

### Running unit tests

Run `nx test plugin-nodejs` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-nodejs` to run
