...
declare module "babel-plugin-parameter-decorator" {
  ...
  function parameterDecorator(options?: ParameterDecoratorOptions): {
    visitor: any;
  };
...
declare module "babel-plugin-transform-typescript-metadata" {
  interface TransformTypeScriptMetadataOptions {
    legacy?: boolean;
    emitDecoratorMetadata?: boolean;
  }
  function transformTypescriptMetadata(
    options?: TransformTypeScriptMetadataOptions
  ): { visitor: any };
  export default transformTypescriptMetadata;
}
...
declare module "@babel/plugin-syntax-import-assertions" {
  ...
  export default importAssertions;
}
...
declare module "@babel/plugin-proposal-decorators" {
  ...
  function decorators(options?: DecoratorsOptions): {
    visitor: any;
  };
