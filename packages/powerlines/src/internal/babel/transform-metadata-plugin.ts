...
/**
 * Given a parameter (or class property) node it returns the first identifier containing the TS Type Annotation.
 */
...
export const transformMetadataBabelPlugin = declare(
  (api: BabelAPI): PluginObj => {
    api.assertVersion(7);

    return {
      name: "powerlines:transform-metadata",
      visitor: {
        Program(programPath) {
          /**
