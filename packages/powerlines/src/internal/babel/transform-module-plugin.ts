...
const lazyImportsHook = (lazy: Lazy): CommonJSHook => ({
  name: `powerlines:transform-modules-commonjs/lazy`,
  version: "7.24.7",
...
export const transformModuleBabelPlugin = declare(
  (api: PluginAPI, options: Options) => {
    api.assertVersion(7);
    ...
    const enumerableModuleMeta =
      api.assumption("enumerableModuleMeta") ?? loose;
  ...
  `;
    ...
    return {
      name: "powerlines:transform-modules-commonjs",
