...
var TagsReflection = class extends _stryke_capnp.Struct {
	...
	_initAlias(length) {
		return _stryke_capnp.utils.initList(0, _stryke_capnp.TextList, length, this);
	}
	set alias(value) {
	...
	_initPermission(length) {
		return _stryke_capnp.utils.initList(2, _stryke_capnp.TextList, length, this);
	}
...
var DefaultValueReflection_Value = class extends _stryke_capnp.Struct {
	...
	get boolean() {
		_stryke_capnp.utils.testWhich("boolean", _stryke_capnp.utils.getUint16(0, this), 1, this);
	...
	get integer() {
		_stryke_capnp.utils.testWhich("integer", _stryke_capnp.utils.getUint16(0, this), 2, this);
	...
	get float() {
		_stryke_capnp.utils.testWhich("float", _stryke_capnp.utils.getUint16(0, this), 3, this);
	...
	get string() {
		_stryke_capnp.utils.testWhich("string", _stryke_capnp.utils.getUint16(0, this), 4, this);
...
var EntityOptions = class EntityOptions extends _stryke_capnp.Struct {
	...
	_initIndexes(length) {
		return _stryke_capnp.utils.initList(4, EntityOptions._Indexes, length, this);
	}
	set indexes(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(4, this));
	}
	toString() {
		return "EntityOptions_" + super.toString();
	}
};
var SerializedTypeObjectLiteral = class SerializedTypeObjectLiteral extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeObjectLiteral._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeObjectLiteral._TypeArguments, length, this);
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypeObjectLiteral._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeObjectLiteral._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
	get kind() {
		return _stryke_capnp.utils.getUint16(0, this);
	}
	...
	get types() {
		return _stryke_capnp.utils.getList(4, SerializedTypeObjectLiteral._Types, this);
	}
	_hasTypes() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(4, this));
	}
	_initTypes(length) {
		return _stryke_capnp.utils.initList(4, SerializedTypeObjectLiteral._Types, length, this);
	}
	set types(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(4, this));
	}
	...
	set tags(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(5, this));
	}
	toString() {
		return "SerializedTypeObjectLiteral_" + super.toString();
	}
};
var SerializedTypeClassType = class SerializedTypeClassType extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeClassType._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeClassType._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypeClassType._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeClassType._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
	...
	get extendsArguments() {
		return _stryke_capnp.utils.getList(6, SerializedTypeClassType._ExtendsArguments, this);
	}
	_hasExtendsArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(6, this));
	}
	_initExtendsArguments(length) {
		return _stryke_capnp.utils.initList(6, SerializedTypeClassType._ExtendsArguments, length, this);
	}
	set extendsArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(6, this));
	}
	...
	get arguments() {
		return _stryke_capnp.utils.getList(7, SerializedTypeClassType._Arguments, this);
	}
	_hasArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(7, this));
	}
	_initArguments(length) {
		return _stryke_capnp.utils.initList(7, SerializedTypeClassType._Arguments, length, this);
	}
	set arguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(7, this));
	}
	...
	set superClass(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(8, this));
	}
	_adoptTypes(value) {
	...
	_initTypes(length) {
		return _stryke_capnp.utils.initList(9, SerializedTypeClassType._Types, length, this);
	}
	set types(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(9, this));
	}
	_adoptTags(value) {
	...
	_hasTags() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(10, this));
	}
	_initTags() {
		return _stryke_capnp.utils.initStructAt(10, TagsReflection, this);
	}
	set tags(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(10, this));
	}
	toString() {
		return "SerializedTypeClassType_" + super.toString();
	}
};
var SerializedTypeParameter = class SerializedTypeParameter extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeParameter._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeParameter._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypeParameter._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeParameter._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
...
var SerializedTypeMethod = class SerializedTypeMethod extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeMethod._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeMethod._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypeMethod._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeMethod._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
	...
	get parameters() {
		return _stryke_capnp.utils.getList(6, SerializedTypeMethod._Parameters, this);
	}
	_hasParameters() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(6, this));
	}
	_initParameters(length) {
		return _stryke_capnp.utils.initList(6, SerializedTypeMethod._Parameters, length, this);
	}
...
var SerializedTypeProperty = class SerializedTypeProperty extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeProperty._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeProperty._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypeProperty._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeProperty._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
...
var SerializedTypeFunction = class SerializedTypeFunction extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeFunction._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeFunction._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypeFunction._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeFunction._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
	...
	get parameters() {
		return _stryke_capnp.utils.getList(6, SerializedTypeFunction._Parameters, this);
	}
	_hasParameters() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(6, this));
	}
	_initParameters(length) {
		return _stryke_capnp.utils.initList(6, SerializedTypeFunction._Parameters, length, this);
	}
	set parameters(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(6, this));
	}
...
var SerializedTypePromise = class SerializedTypePromise extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypePromise._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypePromise._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypePromise._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypePromise._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
...
var SerializedTypeEnum = class SerializedTypeEnum extends _stryke_capnp.Struct {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeEnum._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeEnum._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeEnum._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
	...
	get enumEntries() {
		return _stryke_capnp.utils.getList(4, SerializedTypeEnum._EnumEntries, this);
	}
	_hasEnumEntries() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(4, this));
	}
	_initEnumEntries(length) {
		return _stryke_capnp.utils.initList(4, SerializedTypeEnum._EnumEntries, length, this);
	}
	...
	_initValues(length) {
		return _stryke_capnp.utils.initList(5, _stryke_capnp.TextList, length, this);
	}
	set values(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(5, this));
	}
...
var SerializedTypeUnion = class SerializedTypeUnion extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeUnion._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeUnion._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypeUnion._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeUnion._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
	...
	_initTypes(length) {
		return _stryke_capnp.utils.initList(4, SerializedTypeUnion._Types, length, this);
	}
	set types(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(4, this));
	}
...
var SerializedTypeIntersection = class SerializedTypeIntersection extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeIntersection._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeIntersection._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypeIntersection._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeIntersection._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
	...
	get types() {
		return _stryke_capnp.utils.getList(4, SerializedTypeIntersection._Types, this);
	}
	_hasTypes() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(4, this));
	}
	_initTypes(length) {
		return _stryke_capnp.utils.initList(4, SerializedTypeIntersection._Types, length, this);
	}
	set types(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(4, this));
	}
...
var SerializedTypeArray = class SerializedTypeArray extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeArray._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeArray._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypeArray._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeArray._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
...
var SerializedTypeIndexSignature = class SerializedTypeIndexSignature extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeIndexSignature._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeIndexSignature._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypeIndexSignature._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeIndexSignature._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
...
var SerializedTypePropertySignature = class SerializedTypePropertySignature extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypePropertySignature._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypePropertySignature._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypePropertySignature._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypePropertySignature._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
...
var SerializedTypeMethodSignature = class SerializedTypeMethodSignature extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeMethodSignature._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeMethodSignature._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypeMethodSignature._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeMethodSignature._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
	...
	get parameters() {
		return _stryke_capnp.utils.getList(5, SerializedTypeMethodSignature._Parameters, this);
	}
	_hasParameters() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(5, this));
	}
	_initParameters(length) {
		return _stryke_capnp.utils.initList(5, SerializedTypeMethodSignature._Parameters, length, this);
	}
	set parameters(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(5, this));
	}
...
var SerializedTypeTypeParameter = class SerializedTypeTypeParameter extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeTypeParameter._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeTypeParameter._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypeTypeParameter._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeTypeParameter._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
...
var SerializedTypeInfer = class SerializedTypeInfer extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeInfer._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeInfer._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypeInfer._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeInfer._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
...
var SerializedTypeTupleMember = class SerializedTypeTupleMember extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeTupleMember._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeTupleMember._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypeTupleMember._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeTupleMember._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
...
var SerializedTypeTuple = class SerializedTypeTuple extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeTuple._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeTuple._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypeTuple._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeTuple._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
	...
	_initTypes(length) {
		return _stryke_capnp.utils.initList(4, SerializedTypeTuple._Types, length, this);
	}
	set types(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(4, this));
	}
...
var SerializedTypeRest = class SerializedTypeRest extends _stryke_capnp.Struct {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeRest._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeRest._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeRest._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
...
var SimpleSerializedType = class SimpleSerializedType extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SimpleSerializedType._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SimpleSerializedType._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SimpleSerializedType._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SimpleSerializedType._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
...
var SerializedTypeLiteral_Literal = class extends _stryke_capnp.Struct {
	...
	get symbol() {
		_stryke_capnp.utils.testWhich("symbol", _stryke_capnp.utils.getUint16(2, this), 0, this);
	...
	_initSymbol() {
		_stryke_capnp.utils.setUint16(2, 0, this);
		return _stryke_capnp.utils.initStructAt(4, SerializedTypeLiteralSymbol, this);
	}
	get _isSymbol() {
	...
	get string() {
		_stryke_capnp.utils.testWhich("string", _stryke_capnp.utils.getUint16(2, this), 1, this);
		return _stryke_capnp.utils.getText(4, this);
	}
	get _isString() {
	...
	get number() {
		_stryke_capnp.utils.testWhich("number", _stryke_capnp.utils.getUint16(2, this), 2, this);
		return _stryke_capnp.utils.getFloat64(8, this);
	}
	get _isNumber() {
	...
	get boolean() {
		_stryke_capnp.utils.testWhich("boolean", _stryke_capnp.utils.getUint16(2, this), 3, this);
	...
	get bigint() {
		_stryke_capnp.utils.testWhich("bigint", _stryke_capnp.utils.getUint16(2, this), 4, this);
	...
	_initBigint() {
		_stryke_capnp.utils.setUint16(2, 4, this);
		return _stryke_capnp.utils.initStructAt(4, SerializedTypeLiteralBigInt, this);
	}
	get _isBigint() {
	...
	get regex() {
		_stryke_capnp.utils.testWhich("regex", _stryke_capnp.utils.getUint16(2, this), 5, this);
	...
	_initRegex() {
		_stryke_capnp.utils.setUint16(2, 5, this);
		return _stryke_capnp.utils.initStructAt(4, SerializedTypeLiteralRegex, this);
	}
	get _isRegex() {
...
var SerializedTypeLiteral = class SerializedTypeLiteral extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeLiteral._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeLiteral._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypeLiteral._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeLiteral._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
...
var SerializedTypeTemplateLiteral = class SerializedTypeTemplateLiteral extends _stryke_capnp.Struct {
	static _capnp = {
	...
	get typeArguments() {
		return _stryke_capnp.utils.getList(1, SerializedTypeTemplateLiteral._TypeArguments, this);
	}
	_hasTypeArguments() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(1, this));
	}
	_initTypeArguments(length) {
		return _stryke_capnp.utils.initList(1, SerializedTypeTemplateLiteral._TypeArguments, length, this);
	}
	set typeArguments(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(1, this));
	}
	...
	get decorators() {
		return _stryke_capnp.utils.getList(3, SerializedTypeTemplateLiteral._Decorators, this);
	}
	_hasDecorators() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(3, this));
	}
	_initDecorators(length) {
		return _stryke_capnp.utils.initList(3, SerializedTypeTemplateLiteral._Decorators, length, this);
	}
	set decorators(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(3, this));
	}
	...
	get types() {
		return _stryke_capnp.utils.getList(4, SerializedTypeTemplateLiteral._Types, this);
	}
	_hasTypes() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(4, this));
	}
	_initTypes(length) {
		return _stryke_capnp.utils.initList(4, SerializedTypeTemplateLiteral._Types, length, this);
	}
	set types(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(4, this));
	}
...
var SerializedType_Type = class extends _stryke_capnp.Struct {
	...
	get simple() {
		_stryke_capnp.utils.testWhich("simple", _stryke_capnp.utils.getUint16(0, this), 0, this);
	...
	get literal() {
		_stryke_capnp.utils.testWhich("literal", _stryke_capnp.utils.getUint16(0, this), 1, this);
	...
	get templateLiteral() {
		_stryke_capnp.utils.testWhich("templateLiteral", _stryke_capnp.utils.getUint16(0, this), 2, this);
		return _stryke_capnp.utils.getStruct(0, SerializedTypeTemplateLiteral, this);
	}
	_hasTemplateLiteral() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(0, this));
	}
	_initTemplateLiteral() {
		_stryke_capnp.utils.setUint16(0, 2, this);
		return _stryke_capnp.utils.initStructAt(0, SerializedTypeTemplateLiteral, this);
	}
	...
	get parameter() {
		_stryke_capnp.utils.testWhich("parameter", _stryke_capnp.utils.getUint16(0, this), 3, this);
	...
	get function() {
		_stryke_capnp.utils.testWhich("function", _stryke_capnp.utils.getUint16(0, this), 4, this);
	...
	get method() {
		_stryke_capnp.utils.testWhich("method", _stryke_capnp.utils.getUint16(0, this), 5, this);
	...
	get property() {
		_stryke_capnp.utils.testWhich("property", _stryke_capnp.utils.getUint16(0, this), 6, this);
	...
	get promise() {
		_stryke_capnp.utils.testWhich("promise", _stryke_capnp.utils.getUint16(0, this), 7, this);
	...
	get classType() {
		_stryke_capnp.utils.testWhich("classType", _stryke_capnp.utils.getUint16(0, this), 8, this);
	...
	get enum() {
		_stryke_capnp.utils.testWhich("enum", _stryke_capnp.utils.getUint16(0, this), 9, this);
	...
	get union() {
		_stryke_capnp.utils.testWhich("union", _stryke_capnp.utils.getUint16(0, this), 10, this);
	...
	get intersection() {
		_stryke_capnp.utils.testWhich("intersection", _stryke_capnp.utils.getUint16(0, this), 11, this);
	...
	_initIntersection() {
		_stryke_capnp.utils.setUint16(0, 11, this);
		return _stryke_capnp.utils.initStructAt(0, SerializedTypeIntersection, this);
	}
	get _isIntersection() {
	...
	get array() {
		_stryke_capnp.utils.testWhich("array", _stryke_capnp.utils.getUint16(0, this), 12, this);
	...
	get objectLiteral() {
		_stryke_capnp.utils.testWhich("objectLiteral", _stryke_capnp.utils.getUint16(0, this), 13, this);
	...
	_initObjectLiteral() {
		_stryke_capnp.utils.setUint16(0, 13, this);
		return _stryke_capnp.utils.initStructAt(0, SerializedTypeObjectLiteral, this);
	}
	...
	get indexSignature() {
		_stryke_capnp.utils.testWhich("indexSignature", _stryke_capnp.utils.getUint16(0, this), 14, this);
	...
	_initIndexSignature() {
		_stryke_capnp.utils.setUint16(0, 14, this);
		return _stryke_capnp.utils.initStructAt(0, SerializedTypeIndexSignature, this);
	}
	...
	get propertySignature() {
		_stryke_capnp.utils.testWhich("propertySignature", _stryke_capnp.utils.getUint16(0, this), 15, this);
		return _stryke_capnp.utils.getStruct(0, SerializedTypePropertySignature, this);
	}
	...
	_initPropertySignature() {
		_stryke_capnp.utils.setUint16(0, 15, this);
		return _stryke_capnp.utils.initStructAt(0, SerializedTypePropertySignature, this);
	}
	...
	get methodSignature() {
		_stryke_capnp.utils.testWhich("methodSignature", _stryke_capnp.utils.getUint16(0, this), 16, this);
		return _stryke_capnp.utils.getStruct(0, SerializedTypeMethodSignature, this);
	}
	_hasMethodSignature() {
		return !_stryke_capnp.utils.isNull(_stryke_capnp.utils.getPointer(0, this));
	}
	_initMethodSignature() {
		_stryke_capnp.utils.setUint16(0, 16, this);
		return _stryke_capnp.utils.initStructAt(0, SerializedTypeMethodSignature, this);
	}
	...
	get typeParameter() {
		_stryke_capnp.utils.testWhich("typeParameter", _stryke_capnp.utils.getUint16(0, this), 17, this);
	...
	_initTypeParameter() {
		_stryke_capnp.utils.setUint16(0, 17, this);
		return _stryke_capnp.utils.initStructAt(0, SerializedTypeTypeParameter, this);
	}
	...
	get infer() {
		_stryke_capnp.utils.testWhich("infer", _stryke_capnp.utils.getUint16(0, this), 18, this);
	...
	get tuple() {
		_stryke_capnp.utils.testWhich("tuple", _stryke_capnp.utils.getUint16(0, this), 19, this);
	...
	get tupleMember() {
		_stryke_capnp.utils.testWhich("tupleMember", _stryke_capnp.utils.getUint16(0, this), 20, this);
	...
	get rest() {
		_stryke_capnp.utils.testWhich("rest", _stryke_capnp.utils.getUint16(0, this), 21, this);
	...
	*/
	get other() {
		_stryke_capnp.utils.testWhich("other", _stryke_capnp.utils.getUint16(0, this), 22, this);
...
var SerializedTypes = class SerializedTypes extends _stryke_capnp.Struct {
	...
	_initTypes(length) {
		return _stryke_capnp.utils.initList(0, SerializedTypes._Types, length, this);
	}
	set types(value) {
		_stryke_capnp.utils.copyFrom(value, _stryke_capnp.utils.getPointer(0, this));
	}
...
EntityOptions._Indexes = _stryke_capnp.CompositeList(EntityOptions_EntityIndexOptions);
SerializedTypeObjectLiteral._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeObjectLiteral._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeObjectLiteral._Types = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeClassType._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeClassType._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeClassType._ExtendsArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeClassType._Arguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeClassType._Types = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeParameter._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeParameter._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeMethod._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeMethod._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeMethod._Parameters = _stryke_capnp.CompositeList(SerializedTypeParameter);
SerializedTypeProperty._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeProperty._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeFunction._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeFunction._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeFunction._Parameters = _stryke_capnp.CompositeList(SerializedTypeParameter);
SerializedTypePromise._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypePromise._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeEnum._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeEnum._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeEnum._EnumEntries = _stryke_capnp.CompositeList(SerializedTypeEnumEntry);
SerializedTypeUnion._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeUnion._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeUnion._Types = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeIntersection._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeIntersection._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeIntersection._Types = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeArray._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeArray._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeIndexSignature._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeIndexSignature._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypePropertySignature._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypePropertySignature._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeMethodSignature._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeMethodSignature._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeMethodSignature._Parameters = _stryke_capnp.CompositeList(SerializedTypeParameter);
SerializedTypeTypeParameter._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeTypeParameter._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeInfer._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeInfer._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeTupleMember._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeTupleMember._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeTuple._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeTuple._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeTuple._Types = _stryke_capnp.CompositeList(SerializedTypeTupleMember);
SerializedTypeRest._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeRest._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SimpleSerializedType._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SimpleSerializedType._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeLiteral._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeLiteral._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeTemplateLiteral._TypeArguments = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeTemplateLiteral._Decorators = _stryke_capnp.CompositeList(SerializedTypeReference);
SerializedTypeTemplateLiteral._Types = _stryke_capnp.CompositeList(SerializedTypeReference);
