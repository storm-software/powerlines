...
import { RpcStreamingClientHost } from "./devtools";
...
export type RPCClient<TFunctions extends WrappedRPCFunctions> =
...
export interface LogPayload {
  /**
   * Metadata associated with the log message, excluding fields that are automatically added by the engine such as executionId, executionIndex, environment, and timestamp. This can include custom fields relevant to the log entry, such as category, name, command, hook, plugin, and source.
   */
  meta: LogMeta;
