...
export interface ResolvedEntryFileReference extends FileReference {
  /**
 ...
 * The configuration options for resolving modules in a Powerlines project.
 */
export type ResolvedResolveConfig = Required<
...
export type ResolvedCopyConfig = Required<Omit<CopyConfig, "assets">> & {
  assets: ResolvedAssetGlob[];
};

export type ResolvedOutputConfig = Required<
  Omit<OutputConfig, "copy" | "storage">
> &
 ...
 */
export type EnvironmentResolvedConfig<
  TResolvedConfig extends ResolvedConfig = ResolvedConfig
> = TResolvedConfig & {
  /**
