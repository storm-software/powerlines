...
# Powerlines - TSDoc Configuration (tsdoc.json)

A shared TSDoc configuration containing various tsdoc.json files used in Powerlines projects.
...
- [Powerlines - TSDoc Configuration (tsdoc.json)](#powerlines---tsdoc-configuration-tsdocjson)
...
```bash
npm install -D @powerlines/tsdoc
```
...
Run `nx lint tsdoc` to run [ESLint](https://eslint.org/) on the package.
