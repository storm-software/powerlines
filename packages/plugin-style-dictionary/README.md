...
# Powerlines - Style Dictionary Plugin

A Powerlines plugin to generate project code with [Style Dictionary](https://amzn.github.io/style-dictionary/#/).
...
```bash
pnpm add @powerlines/plugin-style-dictionary
```
...
```bash
npm install @powerlines/plugin-style-dictionary
```
...
```bash
yarn add @powerlines/plugin-style-dictionary
```
...
Run `nx test plugin-style-dictionary` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-style-dictionary` to run
