...
# Powerlines - Content Collections Plugin

A Powerlines plugin to generate project code using [content-collections](https://www.content-collections.dev).
...
- [Powerlines - Content Collections Plugin](#powerlines---content-collections-plugin)
...
```bash
pnpm add @powerlines/plugin-content-collections
```
...
```bash
npm install @powerlines/plugin-content-collections
```
...
```bash
yarn add @powerlines/plugin-content-collections
```
...
Run `nx build plugin-content-collections` to build the library.

### Running unit tests

Run `nx test plugin-content-collections` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-content-collections` to run
