...
# Powerlines - Open Feature Plugin
...
```bash
pnpm add @powerlines/plugin-open-feature
```
...
```bash
npm install @powerlines/plugin-open-feature
```
...
```bash
yarn add @powerlines/plugin-open-feature
```
...
Run `nx build plugin-open-feature` to build the library.

### Running unit tests

Run `nx test plugin-open-feature` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-open-feature` to run [ESLint](https://eslint.org/) on the package.
