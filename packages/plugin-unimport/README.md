...
# Powerlines - Unimport Plugin

A Powerlines plugin to add imports to source code automatically via [unimport](https://github.com/unjs/unimport).
...
- [Powerlines - Unimport Plugin](#powerlines---unimport-plugin)
...
```bash
pnpm add @powerlines/plugin-unimport
```
...
```bash
npm install @powerlines/plugin-unimport
```
...
```bash
yarn add @powerlines/plugin-unimport
```
...
Run `nx build plugin-unimport` to build the library.

### Running unit tests

Run `nx test plugin-unimport` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-unimport` to run
