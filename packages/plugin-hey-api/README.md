...
# Powerlines - Hey API Plugin

A Powerlines plugin to generate project code with [OpenAPI](https://heyapi.dev/).
...
```bash
pnpm add @powerlines/plugin-hey-api
```
...
```bash
npm install @powerlines/plugin-hey-api
```
...
```bash
yarn add @powerlines/plugin-hey-api
```
...
Run `nx test plugin-hey-api` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-hey-api` to run
