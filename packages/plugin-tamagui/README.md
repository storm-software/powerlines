...
# Powerlines - Tamagui Plugin

A package containing the [Tamagui](https://tamagui.dev/) plugin for Powerlines.
...
- [Powerlines - Tamagui Plugin](#powerlines---tamagui-plugin)
...
```bash
pnpm add @powerlines/plugin-tamagui
```
...
```bash
npm install @powerlines/plugin-tamagui
```
...
```bash
yarn add @powerlines/plugin-tamagui
```
...
Run `nx build plugin-tamagui` to build the library.

### Running unit tests

Run `nx test plugin-tamagui` to execute the unit tests via
[Jest](https://jestjs.io).

### Linting

Run `nx lint plugin-tamagui` to run
